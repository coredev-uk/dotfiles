...
_G.packer_plugins = {
  ...
  ["barbar.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/paul/.local/share/nvim/site/pack/packer/opt/barbar.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-path", "cmp-vsnip", "cmp-buffer", "lsp_signature.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-colorizer.lua", "nvim-ts-rainbow", "nvim_context_vt" },
