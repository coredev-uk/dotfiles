        ...
        var __webpack_modules__ = {
            ...
            234: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                function SettingsPanel() {
                    ...
                    }, "Show Desktop Notifications"), external_BdApi_React_default().createElement(Switch, {
                        note: "Whether or not to show BetterDiscord XenoLib notifications when a guild/friend is removed.",
                        value: Settings.get("showXenoNotifs", false),
                        onChange: value => Settings.set("showXenoNotifs", value)
                    }, "Show XenoLib Notifications"));
                }
                ...
                class GuildAndFriendRemovalAlerts extends (external_BasePlugin_default()) {
                    constructor(...args) {
                        ...
                        function renderContent(icon, text, body) {
                            console.log(icon)
                            return (
                                React.createElement(
                                    'div',
                                    ...
                                    React.createElement('span',
                                        {
                                            className: XenoLib.joinClassNames('overflow-WK9Ogt', 'name-3Uvkvr'),
                                            style: {
                                                fontWeight: 800,
                                            }
                                        },
                                    ...
                                    React.createElement(
                                        'div',
                                        {
                                            className: XenoLib.joinClassNames('markup-eYLPri', 'messageContent-2t3eCI')
                                        },
                                        body
                                    ),
                                )
                            ...
                            if (removedGuilds.length || removedFriends.length) {
                                ...
                                if (Settings.get("showXenoNotifs", false)) {
                                    removedGuilds.forEach((guild => {
                                        XenoLib.Notifications.error(renderContent(guild.iconUrl, guild.name, 'Server Left'), { timeout: 0 });
                                    }))
